...
<form action="" method="POST">
    <label for="exampleInputName1">Choose What you want to test for:</label>
...
if ($id==1) {
    ...
    echo "Pattern Used:/^([a-z]+)([a-z\d]+)([\.])*([a-z\d]+)[\@{1}]([a-z]+)[\.]([a-z]+)/"; echo '<br>';
}
else if ($id==2) {
    ...
    echo "Pattern Used:/^(([A-Z]{1})([a-z]+)([\ ]{0,1}))+$/"; echo '<br>';
}
